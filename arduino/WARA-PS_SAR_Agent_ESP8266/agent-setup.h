...
#define A_BASE_NAME   "SAR1_Drone_1"         // Base name of agent.
#define A_TYPE        "esp8266"              // Type of agent.
#define A_DESCR       "Search_and_Rescue_L2_agent"      // Description of agent.
...
#define A_HOME_LAT    57.7710             // WGS84 latitude       in decimal degrees + => north - => south.
#define A_HOME_LON    16.6530             // WGS84 longitude      in decimal degrees + => east  - => west.
