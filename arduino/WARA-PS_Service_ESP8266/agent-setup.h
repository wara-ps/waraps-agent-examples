...
#define A_TOPIC_BASE  "waraps/service"       // Base topic that makes the top for all other sub topics for an agent.

#define A_BASE_NAME   "Path_Planner"         // Base name of agent.
#define A_TYPE        "Planner"              // Type of agent.
#define A_DESCR       "Service Example"      // Description of agent.
#define A_DOMAIN      "virtual"              // The domain for the agent (lowercase): [ground, surface, subsurface, air].
