...
class GpsConfig:
    def random_start_pos():
        ...
        original_x = float(os.getenv('START_LON'))
        original_y = float(os.getenv('START_LAT'))
...
class MqttConfig:
    ...
    #THE TOPIC THE AGENT LISTENS ON FOR COMMANDS
    ...
    WARAPS_PORT: int       = int(os.getenv('WARAPS_PORT')) 
